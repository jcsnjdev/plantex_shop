...
function scrollHeader() {
  ...
  // Quando a rolagem for maior que 80 de altura da viewport, adicione a classe scroll-header à tag do cabeçalho
...
function scrollUp() {
  ...
  // Quando o scroll for maior que 400 viewport height, adicione a classe show-scroll à tag a com a classe scroll-top
...
/*=============== Animação de revelação de scroll ===============*/
